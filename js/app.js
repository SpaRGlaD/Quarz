(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".swiper")) {
                new core(".main-slide__slider", {
                    ...
                    navigation: {
                        prevEl: ".main-slide__arrow_prev",
                        nextEl: ".main-slide__arrow_next"
                    },
                    on: {}
                });
                ...
                new core(".popup-kitchen__slider", {
                    modules: [ Navigation ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
                ...
                new core(".blog-article-slider__slider", {
                    modules: [ Navigation ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
                    ...
                    speed: 800,
                    navigation: {
                        prevEl: ".blog-article-slider__arrow_prev",
                        nextEl: ".blog-article-slider__arrow_next"
                    },
                    on: {}
                });
            }
            if (document.querySelector(".product-thumb__slider")) {
                const thumbsSwiper = new core(".product-thumb__slider", {
                    ...
                    watchSlidesProgress: true,
                    navigation: {
                        prevEl: ".product-thumb__slider-arrow_prev",
                        nextEl: ".product-thumb__slider-arrow_next"
                    },
                    breakpoints: {
                        480: {
                            slidesPerView: 4
        ...
        const cBtn = document.querySelector(".filter-catalog");
        document.addEventListener("click", script_filter);
        function script_filter(event) {
            if (event.target.closest(".filter-catalog__btn")) {
                document.body.classList.toggle("_lock");
                cBtn.classList.toggle("_active");
            }
        }
        let body = document.querySelector("body");
        let i = 0;
